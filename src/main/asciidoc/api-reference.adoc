...
=== if you post NOT Open progress new Todo, return Open progress Todo

.curl
include::{snippets}/postTodoProgressDone/curl-request.adoc[]

.response
include::{snippets}/postTodoProgressDone/http-response.adoc[]
